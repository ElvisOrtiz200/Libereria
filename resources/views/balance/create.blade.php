    ...
    <div class="page-wrapper">
        <div class="container" style="margin-top: 100px">
            ...
            <form method="POST" action="{{route('balance.store')}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text" name="efectivo" id="efectivo" value="0">
                                <input type="text"  name="cuentasxcobrar" id="cuentasxcobrar" value="0">
                                <input type="text"  name="inventario" id="inventario" value="0">
                                <input type="text"  name="inversion" id="inversion" value="0">
                            </div>
                            ...
                            <div class="col-6" style="margin-top: 7px;">
                                <input type="text"  name="TAC" id="TAC" disabled value="0">
                                <input type="text"  name="TAC2" id="TAC2" style="visibility: collapse" value="0">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text"  name="bono" id="bono" value="0">
                                <input type="text"  name="accion" id="accion" value="0">
                                <input type="text"  name="letrasxcobrar" id="letrasxcobrar" value="0">
                                <input type="text"  name="enser" id="enser" value="0">
                            </div>
                            ...
                            <div class="col-6" style="margin-top: 7px;">
                                <input type="text"  name="TANC" id="TANC" disabled value="0">
                                <input type="text"  name="TANC2" id="TANC2" style="visibility: collapse" value="0">
                            </div>
                            ...
                            <div class="col-6" style="margin-top: 110px; padding-top: 20px; background-color:rgb(243, 152, 41)">
                                <input type="text"  name="TA" id="TA" disabled value="0">
                                <input type="text"  name="TA2" id="TA2" style="visibility: collapse" value="0">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text" name="otributaria" id="otributaria" value="0">
                                <input type="text"  name="olaboral" id="olaboral" value="0">
                            </div>
                            ...
                            <div class="col-6" style="margin-top: 7px;">
                                <input type="text"  name="TPC" id="TPC" disabled value="0">
                                <input type="text"  name="TPC2" id="TPC2" style="visibility: collapse" value="0">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text"  name="ocomercial" id="ocomercial" value="0">
                                <input type="text"  name="olargoplazo" id="olargoplazo" value="0">
                            </div>
                            ...
                            <div class="col-6" style="margin-top: 7px;">
                                <input type="text"  name="TPNC" id="TPNC" disabled value="0">
                                <input type="text"  name="TPNC2" id="TPNC2" style="visibility: collapse" value="0">
                            </div>
                            ...
                            <div class="col-6" style=" background-color: bisque">
                                <input type="text"  name="TP" id="TP" disabled value="0">
                                <input type="text"  name="TP2" id="TP2" style="visibility: collapse" value="0">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input type="text"  name="capital" id="capital" value="0">
                                <input type="text"  name="reserva" id="reserva" value="0">
                            </div>
                            ...
                            <div class="col-6" style=" background-color: bisque">
                                <input type="text"  name="TPTR" id="TPTR" disabled value="0">
                                <input type="text"  name="TPTR2" id="TPTR2" style="visibility: collapse" value="0">
                            </div>
                            ...
                            <div class="col-6" style="margin-top: 7px; padding-top: 20px; background-color: rgb(243, 152, 41)">
                                <input type="text"  name="TPYP" id="TPYP" disabled value="0">
                                <input type="text"  name="TPYP2" id="TPYP2" style="visibility: collapse" value="0">
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{route('balance.pindex',$a)}}" class="btn btn-danger">
