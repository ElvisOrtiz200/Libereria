...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div id="camposInput2" style="" class="row">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                       ...
                       @foreach ($recursos as $item)
                           ...
                           <td>{{$item->preciou}}</td>
                           <td>
                            <form action="{{route('cart.store2')}}" method="POST" name="f2">
                                {{ csrf_field() }}
                                <input type="hidden" value="{{ $item->idRecurso }}" id="idrecurso" name="idrecurso">
                                <input type="hidden" value="{{ $item->nombreP }}" id="nombreP" name="nombreP">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                       ...
                       @foreach($cartCollection as $item)
                           ...
                           <td>
                            <form action="{{ route('cart.remove2') }}" method="POST" name="f3">
                                {{ csrf_field() }}
        ...
        <div class="row">
            <form action="{{route('operacion2.store')}}" method="POST" name="f1">
                {{ csrf_field() }}
            <div class="col-md-6">
            ...
            <div class="col-md-6" align="right" style="align-items: end">
                ...
                <a href="{{ route('cart.clear2') }}" style="color: white" class="btn btn-primary">Cancelar</a>
            </div>
            </form>
        </div>
    </div>
