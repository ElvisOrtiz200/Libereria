...
<div class="page-wrapper">
    <div class="content container-fluid">
        <div class="row">
            <form action="{{route('vender')}}" method="POST" name="f1">
                {{ csrf_field() }}
            <div class="col-md-6">
                <h2 class="header-title">Registrar Nueva Venta</h2><br>
                <h3>Cliente</h3>
            ...
            <div class="col-md-6" align="right" style="align-items: end">
                ...
                <a href="{{ route('cart.clear') }}" style="color: white" class="btn btn-primary">Cancelar</a>
            </div>
            </form>
        </div>
        <br>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                       ...
                       @foreach ($recursos as $item)
                           ...
                           <td>{{$item->preciou}}</td>
                           <td>
                            <form action="{{route('cart.store')}}" method="POST" name="f2">
                                {{ csrf_field() }}
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                       ...
                       @foreach($cartCollection as $item)
                           ...
                           <td>
                            <form action="{{ route('cart.remove') }}" method="POST" name="f3">
                                {{ csrf_field() }}
