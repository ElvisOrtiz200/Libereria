        ...
        <div class="login-right-wrap">
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="form-group">
                    <label>Nombres y Apellidos <span class="login-danger">*</span></label>
                ...
                <div style="display:none;"  class="form-group local-forms">
                    <label>Role Name s<span class="login-danger">*</span></label>
                    <select class="form-control select @error('role_name') is-invalid @enderror" name="role_name" id="role_name">
                        @foreach ($role as $name)
                            <option value="Normal User">{{ $name->role_type }}</option>
                        @endforeach
                    </select>
                    @error('role_name')
                ...
                <div class="form-group">
                    <label>Confirm contraseña?<span class="login-danger">*</span></label>
